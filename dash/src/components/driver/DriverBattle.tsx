...
export default function DriverBattle({
	...
	return (
		<div className="space-y-4">
			<div className="glass-strong hover-lift rounded-xl p-4">
				<div className="mb-3 flex items-center justify-between">
					<div className="flex items-center space-x-3">
						...
						<div>
							<div className="font-bold text-white">{driver.lastName}</div>
							<div
								className="text-sm text-white/60"
								style={{ ...(driver.teamColour && { color: `#${driver.teamColour}` }) }}
							>
								{driver.teamName}
							</div>
						</div>
				...
				<div className="flex items-center justify-between">
					<div className="flex items-center space-x-4">
						<div className="flex items-center space-x-4">
							...
							<div className="text-md flex w-16 items-center justify-center space-x-4">
								<DriverDRS
